...
!(function (e, t) {
  ...
  !(function () {
    ...
    try {
      g.apply((n = r.call(D.childNodes)), D.childNodes),
        n[D.childNodes.length].nodeType;
    } catch (e) {
      g = {
        apply: function (e, t) {
          L.apply(e, r.call(t));
    ...
    function Q(e, t, n, i) {
      ...
      if (!i && (le(t), (t = t || c), p)) {
        ...
        if (!(P[e + " "] || (m && m.test(e)))) {
          if (((d = e), (h = t), 1 === y && (H.test(e) || R.test(e)))) {
            for (
    ...
    function ue(e, t) {
      ...
      return t ? o.length : o ? Q.error(e) : x(e, l).slice(0);
    }
    function de(e) {
        ...
        te(function (s, a, l, c) {
          var u,
            ...
            y =
              s ||
              (function (e, t, n) {
                for (var i = 0, r = t.length; i < r; i++) Q(e, t[i], n);
                return n;
              })(t || "*", l.nodeType ? [l] : l, []),
          ...
          } else (f = me(f === a ? f.splice(v, f.length) : f)), r ? r(null, a, f, c) : g.apply(a, f);
        })
      );
    }
    function ge(e) {
    ...
    (ce.prototype = i.filters = i.pseudos),
      (i.setFilters = new ce()),
      (f.sortStable = v.split("").sort(A).join("") === v),
      le(),
  ...
  (T.filter = function (e, t, n) {
    ...
    T.fn.extend({
      ...
      is: function (e) {
        return !!N(this, "string" == typeof e && $.test(e) ? T(e) : e || [], !1)
          .length;
      },
    });
  var j,
      ...
      function (e, t) {
        T.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (q[e] || T.uniqueSort(r), H.test(e) && r.reverse()),
            this.pushStack(r)
          );
        };
      }
  ...
  function Ie(e, t, n, i, r) {
    ...
    for (d.textContent = "", f = 0; (s = p[f++]); )
      if (i && T.inArray(s, i) > -1) r && r.push(s);
        ...
        ((c = fe(s)), (a = Me(d.appendChild(s), "script")), c && _e(a), n)
      )
  ...
  function Be(e, t, n, i) {
    ...
    if (
      p &&
      ((a = (r = Ie(t, e[0].ownerDocument, !1, e, i)).firstChild),
      ...
      for (l = (o = T.map(Me(r, "script"), je)).length; d < p; d++)
        (c = r),
          ...
          n.call(e[d], c, d);
      if (l)
        for (u = o[o.length - 1].ownerDocument, T.map(o, Re), d = 0; d < l; d++)
          (c = o[d]),
            Ce.test(c.type || "") &&
              ...
              (c.src && "module" !== (c.type || "").toLowerCase()
                ...
                : y(c.textContent.replace(Fe, ""), c, u));
    }
    return e;
  }
  function We(e, t, n) {
    for (var i, r = t ? T.filter(t, e) : e, s = 0; null != (i = r[s]); s++)
      n || 1 !== i.nodeType || T.cleanData(Me(i)),
        i.parentNode &&
          (n && fe(i) && _e(Me(i, "script")), i.parentNode.removeChild(i));
    return e;
  }
  T.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        (a = Me(o, "script")).length > 0 && _e(a, !l && Me(e, "script")), o
      );
    },
    ...
    T.fn.extend({
      addClass: function (e) {
        ...
        return m(e)
          ...
          ? this.each(function () {
              if (
                ((i = Et(this)), (n = 1 === this.nodeType && " " + Tt(i) + " "))
              ) {
  ...
  T.extend(T.event, {
    trigger: function (t, n, i, r) {
      ...
      if (
        ...
        if (!r && !p.noBubble && !h(i)) {
          for (
            l = p.delegateType || y, It.test(l + y) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            v.push(a), (o = a);
        ...
        f.hasContent
          ...
          : ((p = f.url.slice(r.length)),
            f.data &&
              ...
              ((r += (kt.test(r) ? "&" : "?") + f.data), delete f.data),
            !1 === f.cache &&
              ((r = r.replace(Nt, "$1")),
              (p = (kt.test(r) ? "&" : "?") + "_=" + _t.guid++ + p)),
            (f.url = r + p)),
        f.ifModified &&
          (T.lastModified[r] &&
  ...
  T.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = Jt.pop() || T.expando + "_" + _t.guid++;
      return (this[e] = !0), e;
    },
  }),
        ...
        return (
          ...
          i.always(function () {
            void 0 === s ? T(e).removeProp(r) : (e[r] = s),
              t[r] && ((t.jsonpCallback = n.jsonpCallback), Jt.push(r)),
              a && m(s) && s(a[0]),
              (a = s = void 0);
          }),
          "script"
  ...
  (window.Modernizr = (function (e, t, n) {
        ...
        var n = k.call(arguments, 1),
          i = function () {
            if (this instanceof i) {
              ...
              var s = new r(),
                a = t.apply(s, n.concat(k.call(arguments)));
    ...
    (C.rgba = function () {
      return (
        i("background-color:rgba(150,255,150,.5)"), s(h.backgroundColor, "rgba")
      );
    }),
    (C.hsla = function () {
      return (
  ...
  (function (e, t) {
    ...
    function $(e) {
      ...
      switch (e.tagName.toLowerCase()) {
        ...
        case "polygon":
          return (
            (n = (t = e).points),
            z(t) + O(n.getItem(n.numberOfItems - 1), n.getItem(0))
          );
      }
      var t, n, i, r, s;
    }
    ...
    function J(n) {
      ...
      function S() {
        (s = 0), (a = C(w.currentTime) * (1 / J.speed));
      }
      function M(e, t) {
      ...
      function _(e) {
        for (var t = 0, n = w.animations, i = n.length; t < i; ) {
          ...
          for (
            ...
            (b = c.isPath
              ? N(c.value, d * x, c.isPathTargetInsideSVG)
              : T + d * (x - T)),
      ...
      function I(e) {
        ...
        (w.progress = r((p / t) * 100, 0, 100)),
          ...
          !w.loopBegan &&
            w.currentTime > 0 &&
            ((w.loopBegan = !0), k("loopBegin")),
          p <= n && 0 !== w.currentTime && _(0),
          ((p >= d && w.currentTime !== t) || !t) && _(t),
          p > n && p < d
            ? (w.changeBegan ||
                ((w.changeBegan = !0),
                (w.changeCompleted = !1),
    ...
    function ee(e, t) {
      ...
      for (var r = i.length; r--; ) {
        var s = i[r],
          a = s.animations;
        Q(e, a), a.length || s.children.length || i.splice(r, 1);
      }
        ...
        return (
          ...
          (n.add = function (i, r) {
            ...
            (u.autoplay = !1),
              ...
              (u.timelineOffset = o.und(r) ? d : D(r, d)),
              l(n),
...
var Swiper = (function () {
  ...
  var D = {
      ...
      updateSlides: function () {
        ...
        const i = e.params,
          ...
          p = m(s, `.${e.params.slideClass}, swiper-slide`),
        ...
        for (let r = 0; r < f; r += 1) {
          ...
          if (
            ((I = 0),
            p[r] && (s = p[r]),
            k && e.grid.updateSlide(r, s, f, t),
            !p[r] || "none" !== v(s, "display"))
          ) {
            if ("auto" === i.slidesPerView) {
              ...
              if (
                ...
                I = e.isHorizontal() ? x(s, "width", !0) : x(s, "height", !0);
              else {
                const e = n(a, "width"),
                  t = n(a, "padding-left"),
                  i = n(a, "padding-right"),
              ...
              (I = (a - (i.slidesPerView - 1) * C) / i.slidesPerView),
                i.roundLengths && (I = Math.floor(I)),
        ...
        if (
          ...
          i.setWrapperSize && (r.style[t("width")] = `${e.virtualSize + C}px`),
          k && e.grid.updateWrapperSize(I, h, t),
          !i.centeredSlides)
        ) {
          const t = [];
        ...
        if (
          ...
          if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -u;
            ...
            if (!s.support.smoothScroll)
              return (
                p({ swiper: s, targetPosition: -u, side: e ? "left" : "top" }),
                !0
              );
    ...
    $ = {
      ...
      loopFix: function (e) {
        ...
        let x = 0,
          T = 0;
        if (s < h) {
          x = Math.max(h - s, f.slidesPerGroup);
          for (let e = 0; e < h - s; e += 1) {
            const t = e - Math.floor(e / c.length) * c.length;
            g.push(c.length - t - 1);
          }
        } else if (s > l.slides.length - 2 * h) {
          T = Math.max(s - (l.slides.length - 2 * h), f.slidesPerGroup);
          for (let e = 0; e < T; e += 1) {
            const t = e - Math.floor(e / c.length) * c.length;
            v.push(t);
          }
  ...
  function N(e) {
    const t = i(),
      n = this,
      r = n.touchEventsData,
      { params: s, touches: a, rtlTranslate: l, enabled: c } = n;
    if (!c) return;
    ...
    const p = r.evCache.length > 1 ? r.evCache[0] : u,
      f = p.pageX,
      m = p.pageY;
    if (u.preventedByNestedSwiper) return (a.startX = f), void (a.startY = m);
    if (!n.allowTouchMove)
      return (
    ...
    if (s.touchReleaseOnEdges && !s.loop)
      if (n.isVertical()) {
        if (
          (m < a.startY && n.translate <= n.maxTranslate()) ||
          (m > a.startY && n.translate >= n.minTranslate())
        )
    ...
    const w = n.params.loop && !s.cssMode,
      x =
        ("next" === n.swipeDirection && n.allowSlideNext) ||
        ("prev" === n.swipeDirection && n.allowSlidePrev);
    if (!r.isMoved) {
      if (
        (w && x && n.loopFix({ direction: n.swipeDirection }),
    ...
    r.isMoved &&
      ...
      x &&
      Math.abs(v) >= 1 &&
      (n.loopFix({ direction: n.swipeDirection, setTranslate: !0 }), (T = !0)),
      n.emit("sliderMove", u),
      (r.isMoved = !0),
    ...
    return (
      e.params.createElements &&
        Object.keys(i).forEach((r) => {
          if (!n[r] && !0 === n.auto) {
            let s = m(e.el, `.${i[r]}`)[0];
            s || ((s = h("div", i[r])), (s.className = i[r]), e.el.append(s)),
              (n[r] = s),
              (t[r] = s);
          }
        }),
  ...
  function ce(e, t, n) {
    ...
    return s || ((s = h("div", i.split(" "))), r.append(s)), s;
  }
  ...
  const ue = [
    function (e) {
      ...
      function u(e) {
        ...
        (v = n.rtlTranslate ? "right" : n.isHorizontal() ? "left" : "top"),
          r
            ? ((y = Math.floor(t / 2) + i + l), (b = Math.floor(t / 2) + i + o))
            : ((y = t + (i - 1) + l), (b = (s ? t : i) + o));
        let w = g - b,
          x = g + y;
        s || ((w = Math.max(w, 0)), (x = Math.min(x, p.length - 1)));
    ...
    function (e) {
      ...
      function g(e) {
        ...
        if (
          ...
          const e = { time: o(), delta: Math.abs(f), direction: Math.sign(f) },
            i =
              u &&
              e.time < u.time + 500 &&
              e.delta <= u.delta &&
          ...
          if (!i) {
            u = void 0;
            let o = t.getTranslate() + f * s.sensitivity;
        ...
        if (t.params.loop) {
          ...
          const e = t.realIndex,
            ...
            s = (i) => {
              ...
              t.loopFix({ direction: i, activeSlideIndex: n, slideTo: !1 }),
                r === t.activeIndex && t.slideToLoop(e, 0, !1, !0);
            };
          if (n > t.slides.length - t.loopedSlides) s(n > r ? "next" : "prev");
          else if (t.params.centeredSlides) {
            const e =
              "auto" === t.params.slidesPerView
                ? t.slidesPerViewDynamic()
                : Math.ceil(parseFloat(t.params.slidesPerView, 10));
            n < Math.floor(e / 2) && s("prev");
          }
          t.slideToLoop(i);
        } else t.slideTo(i);
      }
    ...
    function (e) {
      ...
      function S() {
        ...
        "string" == typeof i.el &&
          ...
          r &&
            ((s = r.querySelector(`.${t.params.scrollbar.dragClass}`)),
            s || ((s = h("div", t.params.scrollbar.dragClass)), r.append(s))),
      ...
      n({
        ...
        r("init", () => {
          !1 === t.params.scrollbar.enabled ? _() : (S(), y(), v());
        }),
    ...
    function (e) {
        ...
        if (((o = !1), (c = !1), p.push(e), !(p.length < 2))) {
          ...
          if (f.imageEl) {
            const [e, t] = (function () {
              ...
              return [
                (p[0].pageX + (p[1].pageX - p[0].pageX) / 2 - e.x - a.scrollX) /
                  u,
                (p[0].pageY + (p[1].pageY - p[0].pageY) / 2 - e.y - a.scrollY) /
                  u,
              ];
            })();
            (f.originX = e),
      ...
      function C(e) {
        ...
        r >= 0 && p.splice(r, 1),
          o &&
            ...
            (c = !1),
            f.imageEl &&
              ((i.scale = Math.max(Math.min(i.scale, f.maxRatio), n.minRatio)),
      ...
      function S(e) {
        ...
        e.cancelable && e.preventDefault(),
          e.stopPropagation(),
          (h.isMoved = !0);
        const s = (n.scale - u) / (f.maxRatio - t.params.zoom.minRatio),
      ...
      function _(e) {
        ...
        let r, s, o, l, c, d, p, v, y, w, x, T, E, C, S, M, _, k;
        t.params.cssMode &&
          ((t.wrapperEl.style.overflow = "hidden"),
          ...
          void 0 === h.touchesStart.x && e
            ? ((r = e.pageX), (s = e.pageY))
            : ((r = h.touchesStart.x), (s = h.touchesStart.y));
        const I = "number" == typeof e ? e : null;
        1 === u && I && ((r = void 0), (s = void 0)),
          (n.scale =
            I || f.imageWrapEl.getAttribute("data-swiper-zoom") || i.maxRatio),
          (u =
            I || f.imageWrapEl.getAttribute("data-swiper-zoom") || i.maxRatio),
          !e || (1 === u && I)
            ? ((p = 0), (v = 0))
            : ((_ = f.slideEl.offsetWidth),
              (k = f.slideEl.offsetHeight),
              (o = g(f.slideEl).left + a.scrollX),
              (l = g(f.slideEl).top + a.scrollY),
              (c = o + _ / 2 - r),
              (d = l + k / 2 - s),
      ...
      function A() {
        ...
        t.wrapperEl.addEventListener("pointerdown", T, n),
          ...
          ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
            t.wrapperEl.addEventListener(e, C, n);
          }),
      ...
      function D() {
        ...
        t.wrapperEl.removeEventListener("pointerdown", T, n),
          ...
          ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
            t.wrapperEl.removeEventListener(e, C, n);
          }),
          ...
          t.zoom.enabled &&
            (function () {
              ...
              const r = v.x * n,
                ...
                a = v.y * i,
                o = h.currentY + a;
              0 !== v.x && (n = Math.abs((s - h.currentX) / v.x)),
        ...
        i("afterInit", () => {
          t.params.a11y.enabled &&
            (() => {
              ...
              (p = a(p)),
                (f = a(f)),
                p && p.forEach((t) => b(t, s, e.nextSlideMessage)),
                f && f.forEach((t) => b(t, s, e.prevSlideMessage)),
                v() &&
    ...
    function (e) {
      ...
      const w = () => {
        ...
        _ = (e) => {
          "mouse" === e.pointerType &&
            ((h = !0), r.animating || r.autoplay.paused || C(!0));
        },
        k = (e) => {
      ...
      a("init", () => {
        r.params.autoplay.enabled &&
          (r.params.autoplay.pauseOnMouseEnter &&
            (r.el.addEventListener("pointerenter", _),
        ...
        a("destroy", () => {
          r.el.removeEventListener("pointerenter", _),
        ...
        a("beforeTransitionStart", (e, t, n) => {
          !r.destroyed &&
            r.autoplay.running &&
            (n || !r.params.autoplay.disableOnInteraction ? C(!0, !0) : E());
        }),
        a("sliderFirstMove", () => {
          !r.destroyed &&
            r.autoplay.running &&
        ...
        Object.assign(r.autoplay, { start: T, stop: E, pause: C, resume: S });
    },
    function (e) {
        ...
        (s.grid = {
          ...
          updateSlide: (e, r, a, o) => {
            const { slidesPerGroup: c } = s.params,
              u = l(),
              { rows: d, fill: p } = s.params.grid;
            let f, m, h;
            if ("row" === p && c > 1) {
              const n = Math.floor(e / (c * d)),
                i = e - d * c * n,
                s = 0 === n ? c : Math.min(Math.ceil((a - n * d * c) / d), c);
              (h = Math.floor(i / s)),
                (m = i - h * s + n * c),
                (f = m + (h * t) / d),
                (r.style.order = f);
            ...
            (r.row = h),
              (r.column = m),
              (r.style[o("margin-top")] = 0 !== h ? u && `${u}px` : "");
          },
          updateWrapperSize: (e, n, i) => {
            const { centeredSlides: r, roundLengths: a } = s.params,
              o = l(),
              { rows: c } = s.params.grid;
            if (
              ((s.virtualSize = (e + o) * t),
              (s.virtualSize = Math.ceil(s.virtualSize / c) - o),
              (s.wrapperEl.style[i("width")] = `${s.virtualSize + o}px`),
              r)
            ) {
              const e = [];
        ...
        setTranslate: () => {
          ...
          u.shadow &&
            (d
              ? ((f = t.wrapperEl.querySelector(".swiper-cube-shadow")),
                f ||
                  ((f = h("div", "swiper-cube-shadow")), t.wrapperEl.append(f)),
                (f.style.height = `${s}px`))
          ...
          for (let e = 0; e < i.length; e += 1) {
            ...
            n % 4 == 0
              ...
              o && (f = -f),
              d || ((h = f), (f = 0));
            const v = `rotateX(${d ? 0 : -s}deg) rotateY(${
              d ? s : 0
    ...
    function (e) {
      ...
      const r = (e, n) => {
        ...
        i || (i = ce("flip", e, t.isHorizontal() ? "left" : "top")),
          r || (r = ce("flip", e, t.isHorizontal() ? "right" : "bottom")),
          ...
          setTranslate: () => {
            ...
            for (let e = 0, t = i.length; e < t; e += 1) {
              ...
              if (
                ...
                e || (e = ce("coverflow", t, a ? "left" : "top")),
                  n || (n = ce("coverflow", t, a ? "right" : "bottom")),
        ...
        setTranslate: () => {
          ...
          for (let n = 0; n < e.length; n += 1) {
            ...
            if ((m && h.shadow) || !m) {
              ...
              if ((!e && h.shadow && (e = ce("creative", i)), e)) {
 ...
 */ !(function (e) {
  ...
  (function (e) {
              ...
              if (s.length > 0) {
                ...
                "replaceWith" === a
                  ...
                  ? s.is("img")
                    ? s.attr("src", i)
                    : s.replaceWith(
                        e("<img>").attr("src", i).attr("class", s.attr("class"))
                      )
                  : s.attr(r[1], i);
              }
    ...
    var S,
      ...
      k = "inline",
      I = function () {
        _ && (M.after(_.addClass(S)).detach(), (_ = null));
      };
          ...
          if ((I(), n.src)) {
            ...
            if (s.length) {
              ...
              a &&
                ...
                (_ = s.after(M).detach().removeClass(S))),
        ...
        initGallery: function () {
          ...
          (s += " mfp-gallery"),
            ...
            w(c + r, function (e, i, r, s) {
              ...
              r.counter = a > 1 ? R(n.tCounter, s.index, a) : "";
            }),
    ...
    (i.prototype = {
      _init: function () {
        ...
        this._preload(),
          ...
          o &&
            ...
            "string" == typeof o && i.css("background-image", "url(" + o + ")"),
            (this.$overlay = i),
            this.$elmt.prepend(i)),
          this.$elmt.addClass("vegas-container"),
          s || (this.$elmt.append(n), n.append(t)),
          setTimeout(function () {
            l.trigger("init"),
              l._goto(l.slide),
      ...
      _goto: function (t) {
            ...
            setTimeout(function () {
              v &&
                (h.support.transition
                  ...
                  : n.fadeIn(y));
              for (var e = 0; e < o.length - h.settings.slidesToKeep; e++)
                o.eq(e).remove();
        ...
        this.settings.firstTransition &&
          ...
          this.support.transition && v && n.addClass("vegas-transition-" + v),
          this.support.video && c
            ? (((s =
                c instanceof Array ? this._video(c) : this._video(c.src)).loop =
                void 0 === c.loop || c.loop),
              (s.muted = void 0 === c.mute || c.mute),
              !1 === s.muted
                ? ((s.volume = 0), this._fadeInSound(s, y))
                : s.pause(),
              (r = e(s).addClass("vegas-video").css("background-color", m)),
          ...
          g ? o.eq(g - 1).after(n) : this.$elmt.prepend(n),
          ...
          h._timer(!1),
          s
            ? (4 === s.readyState && (s.currentTime = 0), s.play(), x())
            : ((a.src = l), a.complete ? x() : (a.onload = x));
      },
      _end: function () {
            ...
            if (i.tmp.bubble_duration_end)
              null != r &&
                ((l =
                  ...
                  (t -
                    (s -
                      (u * (s - t)) / i.interactivity.modes.bubble.duration))),
    ...
    (i.fn.modes.repulseParticle = function (e) {
      if (
        ...
        var t = e.x - i.interactivity.mouse.pos_x,
          ...
          o = { x: e.x + s.x * a, y: e.y + s.y * a };
        "bounce" == i.particles.move.out_mode
          ? (o.x - e.radius > 0 && o.x + e.radius < i.canvas.w && (e.x = o.x),
            o.y - e.radius > 0 && o.y + e.radius < i.canvas.h && (e.y = o.y))
          : ((e.x = o.x), (e.y = o.y));
      } else if (
        i.interactivity.events.onclick.enable &&
        isInArray("repulse", i.interactivity.events.onclick.mode)
    ...
    (i.fn.vendors.checkOverlap = function (e, t) {
      for (var n = 0; n < i.particles.array.length; n++) {
        var r = i.particles.array[n],
          s = e.x - r.x,
          a = e.y - r.y;
        Math.sqrt(s * s + a * a) <= e.radius + r.radius &&
  ...
  (function (e, t) {
    ...
    return function (e, t, n, i) {
      ...
      var o,
        ...
        Be = function (e) {
          e && (V || X || ne || B) && (e.preventDefault(), e.stopPropagation());
        },
        We = function () {
        ...
        Ye = 0,
        Xe = function (e) {
          Ge[e] && (Ge[e].raf && D(Ge[e].raf), Ye--, delete Ge[e]);
        },
        Ve = function (e) {
        ...
        Ke = {
          ...
          setScrollOffset: function (e, t) {
            (me.x = e), ($ = me.y = t), Se("updateScrollOffset", me);
          },
          ...
          init: function () {
            if (!o && !l) {
              ...
              t && (s.ui = new t(s, r)).init(),
                ...
                void 0 === $ && (Se("initialLayout"), ($ = O = r.getScrollY()));
              var c = "pswp--open ";
              for (
              ...
              z || r.bind(s.scrollWrap, m, s),
                Ce("initialZoomInEnd", function () {
                  s.setContent(T[0], u - 1),
                    ...
                    F.transform && r.bind(s.scrollWrap, "click", s),
                    a.mouseUsed || r.bind(document, "mousemove", Fe),
          ...
          close: function () {
            o &&
              ...
              r.unbind(document, "mousemove", Fe),
              F.transform && r.unbind(s.scrollWrap, "click", s),
                ...
                for (var i = 0; i < n; i++)
                  ge > 0
                    ? ((t = T.shift()),
                      (T[2] = t),
                      p++,
                      Ae((p + 2) * he.x, t.el.style),
                      s.setContent(t, u - n + i + 1 + 1))
                    : ((t = T.pop()),
                      T.unshift(t),
                      p--,
                      Ae(p * he.x, t.el.style),
                      s.setContent(t, u + n - i - 1 - 1));
                if (te && 1 === Math.abs(ge)) {
                  var r = Rt(E);
            ...
            if (0 !== e)
              if (
                ...
                if (
                  ...
                  return;
                Oe(Qe, K[1]), X || ((X = !0), Se("zoomGestureStarted"));
                var t = ft(Je, Qe),
                  n = Ot(t);
                n >
                ...
                if (
                  ...
                  (ce.y += et.y), (de.y += et.y);
                  var c = xt();
                  return (B = !0), Se("onVerticalDrag", c), _e(c), void Ie();
                }
                !(function (e, t, n) {
                  if (e - R > 50) {
                    var i = st.length > 2 ? st.shift() : {};
                    (i.x = t), (i.y = n), st.push(i), (R = e);
                  }
                })(Me(), Je.x, Je.y),
                  (V = !0),
                  (ee = s.currItem.bounds),
                  Mt("x", et) || (Mt("y", et), ze(de), Ie());
              }
          }
        },
        Pt = function (e) {
          ...
          if (
            ...
            if ((Ue(), H || (H = At()), H.calculateSwipeSpeed("x"), B))
              ...
              ne ||
                ("swipe" === i ? !Z && g > s.currItem.fitRatio && Dt(H) : zt());
            }
        },
        At = function () {
          var e,
            ...
            n = {
              ...
              panAnimLoop: function () {
                if (
                  Ge.zoomPan &&
                  ((Ge.zoomPan.raf = A(n.panAnimLoop)),
                  (n.now = Me()),
        ...
        Lt = function (e, t) {
          ...
          return (
            ...
            Ze("mainScroll", ut.x, p, d, r.easing.cubic.out, De, function () {
              Ue(),
                (ne = !1),
                (ot = -1),
        ...
        publicMethods: {
          ...
          setContent: function (e, t) {
            ...
            if (l) {
              ...
              Nt || t !== u ? Pe(l) : ((te = c.style), qt(l, i || l.img)),
                (e.el.innerHTML = ""),
                e.el.appendChild(c);
            } else e.el.innerHTML = "";
          },
            ...
            setupDesktopZoom: function (t) {
              ...
              Ce("bindEvents", function () {
                ...
                Ce("unbindEvents", function () {
                  Qt && r.unbind(e, n, s.handleMouseWheel);
                }),
                (s.mouseZoomedIn = !1);
              var i,
                a = function () {
...
function getCurrentTheme() {
  let e = window.matchMedia("(prefers-color-scheme: dark)").matches
    ...
    : "light";
  return (
    localStorage.getItem("helio.theme") &&
      (e = localStorage.getItem("helio.theme")),
    e
  );
}
function loadTheme(e) {
  ...
  (themeBtn.innerHTML =
    "light" === e
      ? '<em></em><i class="ph ph-moon-stars"></i>'
      : '<em></em><i class="ph ph-sun"></i>'),
    t.setAttribute("color-scheme", `${e}`);
}
themeBtn.addEventListener("click", () => {
  let e = getCurrentTheme();
  (e = "dark" === e ? "light" : "dark"),
    localStorage.setItem("helio.theme", `${e}`),
    loadTheme(e);
}),
    ...
    e.on("click", function (n) {
      ...
      o.on("click", function (s) {
        s.preventDefault(),
          ...
          setTimeout(function () {
            n.addClass("inner-is-visible");
          }, 500),
          setTimeout(function () {
            t.removeClass("is-visible"), e.removeClass("menu-is-visible");
          }, 800);
      }),
      ...
      d.on("click", function (e) {
        e.preventDefault(),
          i.removeClass("animate-out"),
          r.removeClass("animate-in"),
          setTimeout(function () {
            n.removeClass("inner-is-visible");
          }, 100),
          setTimeout(function () {
      ...
      p.on("click", function (e) {
        e.preventDefault(),
          i.removeClass("animate-out"),
          s.removeClass("animate-in"),
          setTimeout(function () {
            n.removeClass("inner-is-visible");
          }, 100),
          setTimeout(function () {
            s.animate({ scrollTop: 0 }),
      ...
      f.on("click", function (e) {
        e.preventDefault(),
          i.removeClass("animate-out"),
          a.removeClass("animate-in"),
          setTimeout(function () {
            n.removeClass("inner-is-visible");
          }, 100),
          setTimeout(function () {
            a.animate({ scrollTop: 0 }),
      ...
      e.preventDefault(),
        m
          ...
          .one(
            ...
            function () {
              g.addClass("is-scaled-up");
            }
          );
    }),
      g.on("click", function (e) {
        e.preventDefault(),
          g.removeClass("is-scaled-up"),
          setTimeout(function () {
            m.addClass("animate-out");
          }, 300),
          setTimeout(function () {
            m.removeClass("animate-in animate-out");
          }, 1e3);
      }),
      $(".hover-anim")
